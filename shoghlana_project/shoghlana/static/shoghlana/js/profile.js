...
//     document.getElementById("profile-email").textContent = localStorage.getItem("email") || "email@Shoghlana.com";
...
//     const postedJobsButton = document.getElementById('posted-jobs');
//     const appliedJobsButton = document.getElementById('applied-jobs');

//     if (userType === 'Admin') {
//         appliedJobsButton.style.display = 'none';
//     } else if (userType === 'User') {
//         postedJobsButton.style.display = 'none';
//     }
